...
export const fetchUserAction: AsyncThunkPayloadCreator<User, string, any> = async (id: string, { rejectWithValue }) => {
  try {
    const user = (await userAdapter.fetchUser(id)) as unknown as User;
