...
describe('Pagination:', () => {
  describe('given valid props', () => {
    it('renders the component', async () => {
      render(
        <Pagination totalRowCount={12} perPageLimit={10} currentPage={1} totalPageCount={2} handleChange={jest.fn()} />,
      );
  ...
  describe('given totalLength is zero', () => {
    it('does not render the component', async () => {
      render(
        <Pagination totalRowCount={0} perPageLimit={10} currentPage={1} totalPageCount={0} handleChange={jest.fn()} />,
      );
